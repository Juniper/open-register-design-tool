...
void  ordt_drv_root::build() {
  ...
  std::shared_ptr<ordt_drv_regset> primary_3 = std::make_shared<ordt_drv_regset>("primary");
  primary_3->add_child(1, base_regs_1, 1, 0, 32);
  std::shared_ptr<ordt_drv_regset> base_map_0 = std::make_shared<ordt_drv_regset>("base_map");
  base_map_0->add_child(1, primary_3, 1, 32, 32);
  base_map_0->add_child(1, base_regs_1, 1, 0, 32);
