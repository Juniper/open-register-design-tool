...
class ordt_drv_root(ordt_drv_regset):
    ...
    def build(self):
        config_regs_8 = ordt_drv_reg('config_regs', 32)
        config_regs_8.add_field('lsb_field', 0, 16, True, True, 65535)
        config_regs_8.add_field('msb_field', 16, 16, True, True, 0)
        base_regs_7 = ordt_drv_regset('base_regs')
        base_regs_7.add_child(1, config_regs_8, 8, 0, 4)
        primary_9 = ordt_drv_regset('primary')
        primary_9.add_child(1, base_regs_7, 1, 0, 32)
        base_map_6 = ordt_drv_regset('base_map')
        base_map_6.add_child(1, primary_9, 1, 32, 32)
        base_map_6.add_child(1, base_regs_7, 1, 0, 32)
        self.add_child(1, base_map_6, 1, 0, 0)
