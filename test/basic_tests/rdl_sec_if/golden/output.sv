//   Ordt 161007.01 autogenerated file 
//   Input: ./rdl_sec_if/test.rdl
//   Parms: ./rdl_sec_if/test.parms
//   Date: Fri Oct 07 14:48:39 EDT 2016
//
...
(
  ...
  p2_e1_cntl_mode,
  p2_e1_cntl_start,
  p2_e1_cntl_force_stop,
  p2_e1_cntl_stop_on_read,
  p2_e1_cntl_stop_on_count,
  p2_e1_cntl_trans_delay,
  p2_e1_cntl_read_capture_mode,
  p2_e1_write_data_val,
  p2_e1_write_mask_val,
  p2_e1_address_start_val,
  p2_e1_address_step_val,
  p2_e1_max_trans_count_val,
  p2_e1_read_match_data_val,
  p2_e1_read_mask_val,
  l2d_base_regs_config_regs_0_r,
  l2d_base_regs_config_regs_1_r,
  l2d_base_regs_config_regs_2_r,
  ...
  p2_e1_status_state,
  p2_e1_status_nack_error,
  p2_e1_status_bad_address_error,
  p2_e1_last_read_data_val,
  d2l_base_regs_config_regs_0_w,
  d2l_base_regs_config_regs_0_we,
  d2l_base_regs_config_regs_0_re,
  d2l_base_regs_config_regs_1_w,
  ...
  input     [1:0] p2_e1_cntl_mode;
  input    p2_e1_cntl_start;
  input    p2_e1_cntl_force_stop;
  input     [1:0] p2_e1_cntl_stop_on_read;
  input    p2_e1_cntl_stop_on_count;
  input     [9:0] p2_e1_cntl_trans_delay;
  input     [1:0] p2_e1_cntl_read_capture_mode;
  input     [31:0] p2_e1_write_data_val;
  input     [31:0] p2_e1_write_mask_val;
  input     [5:2] p2_e1_address_start_val;
  input     [5:2] p2_e1_address_step_val;
  input     [17:2] p2_e1_max_trans_count_val;
  input     [31:0] p2_e1_read_match_data_val;
  input     [31:0] p2_e1_read_mask_val;
  ...
  output     [2:0] p2_e1_status_state;
  output    p2_e1_status_nack_error;
  output    p2_e1_status_bad_address_error;
  output     [31:0] p2_e1_last_read_data_val;
  ...
  logic   [31:0] d2h_primary_w;
  logic  d2h_primary_we;
  logic  d2h_primary_re;
  logic   [31:0] d2h_primary_w_next;
  logic  d2h_primary_we_next;
  logic  d2h_primary_re_next;
  logic   [4:2] d2h_primary_addr;
  logic   [4:2] d2h_primary_addr_next;
  logic  h2d_primary_ack;
  logic  h2d_primary_nack;
  ...
  logic  p2_e1_status_nack_error;
  logic  p2_e1_status_bad_address_error;
  ...
  logic   [31:0] p2_e1_last_read_data_val;
  logic   [31:0] p2_e1_last_read_data_val_next;
  logic   [2:0] p2_e1_status_state;
  ...
  assign  h2d_primary_r = r16_primary_rdata_accum;
  ...
  always_comb begin
    p2_e1_state_next = p2_e1_status_state;
    ...
    p2_e1_last_read_data_val_next = p2_e1_last_read_data_val;
    p2_e1_status_nack_error =  1'b0;
    p2_e1_status_bad_address_error =  1'b0;
    p2_e1_trans_count_next = p2_e1_trans_count;
    p2_pio_dec_address_next = {1'b0, p2_pio_dec_address};
    p2_e1_delay_count_next = 10'b0;
    case (p2_e1_status_state)
      3'h0: begin // IDLE
          p2_e1_trans_count_next = 41'b0;
          p2_pio_dec_address_next = {1'b0, p2_e1_address_start_val};
          if (p2_e1_cntl_start && !p2_e1_cntl_force_stop) begin
            if (p2_e1_cntl_read_capture_mode == 2'h1)
              p2_e1_last_read_data_val_next = ~32'b0;
            else
              p2_e1_last_read_data_val_next = 32'b0;
            if ((p2_e1_cntl_mode == 2'h1) || (p2_e1_cntl_mode == 2'h2)) begin
              p2_e1_state_next = 3'h1;
            end
            else begin
              p2_e1_state_next = 3'h2;
              p2_pio_dec_write_data_next = p2_e1_write_data_val;
            end
          end
        end
      3'h1: begin // READ_WAIT
          p2_e1_delay_count_next = p2_e1_delay_count + 10'b1;
          if (p2_e1_cntl_force_stop) begin
            p2_e1_state_next = 3'h0;
          end
          else if (p2_e1_delay_count == p2_e1_cntl_trans_delay) begin
              p2_e1_state_next = 3'h3;
              p2_pio_dec_read_next =  1'b1;
              p2_arb_atomic_request_next =  (p2_e1_cntl_mode == 2'h2);
          end
          else if (|p2_e1_trans_count) begin
            if ((p2_e1_cntl_stop_on_read == 2'h2) && ((p2_e1_last_read_data_val & ~p2_e1_read_mask_val) == p2_e1_read_match_data_val))
              p2_e1_state_next = 3'h0;
            if ((p2_e1_cntl_stop_on_read == 2'h1) && ((p2_e1_last_read_data_val & ~p2_e1_read_mask_val) < p2_e1_read_match_data_val))
              p2_e1_state_next = 3'h0;
            if ((p2_e1_cntl_stop_on_read == 2'h3) && ((p2_e1_last_read_data_val & ~p2_e1_read_mask_val) > p2_e1_read_match_data_val))
              p2_e1_state_next = 3'h0;
          end
        end
      ...
      3'h3: begin // READ
          if (p2_dec_pio_ack) begin
            if (p2_e1_cntl_mode == 2'h1) begin
              p2_e1_trans_count_next = p2_e1_trans_count + 41'b1;
              p2_pio_dec_address_next = p2_pio_dec_address + p2_e1_address_step_val;
            end
            if (p2_e1_cntl_read_capture_mode == 2'h3)
              p2_e1_last_read_data_val_next = p2_dec_pio_read_data;
            if ((p2_e1_cntl_read_capture_mode == 2'h1) && (p2_dec_pio_read_data < p2_e1_last_read_data_val))
              p2_e1_last_read_data_val_next = p2_dec_pio_read_data;
            if ((p2_e1_cntl_read_capture_mode == 2'h2) && (p2_dec_pio_read_data > p2_e1_last_read_data_val))
              p2_e1_last_read_data_val_next = p2_dec_pio_read_data;
            if (p2_e1_cntl_force_stop) begin
              p2_e1_state_next = 3'h0;
            end
            else if (p2_e1_cntl_mode == 2'h2) begin
              p2_e1_state_next = 3'h4;
              p2_pio_dec_write_next =  1'b1;
              p2_pio_dec_write_data_next = ((p2_e1_write_data_val & ~p2_e1_write_mask_val) | (p2_dec_pio_read_data & p2_e1_write_mask_val));
            end
            else if (p2_e1_cntl_mode == 2'h1) begin
              if (p2_e1_cntl_stop_on_count && (p2_e1_trans_count_next == {1'b0,p2_e1_max_trans_count_val}))
                p2_e1_state_next = 3'h0;
              else if (p2_pio_dec_address_next [6]  == 1'b1) begin
                p2_e1_state_next = 3'h0;
                p2_e1_status_bad_address_error =  1'b1;
              end
              else begin
                p2_e1_state_next = 3'h1;
              end
      ...
      3'h4: begin // WRITE
          if (p2_dec_pio_ack) begin
            ...
            if ((p2_e1_cntl_stop_on_count && (p2_e1_trans_count_next == {1'b0,p2_e1_max_trans_count_val})) || p2_e1_cntl_force_stop) begin
              p2_e1_state_next = 3'h0;
            end
            else if (p2_pio_dec_address_next [6]  == 1'b1) begin
              p2_e1_state_next = 3'h0;
  ...
  always_ff @ (posedge clk) begin
    if (reset) begin
      p2_e1_status_state <= #1  3'b0;
      p2_e1_trans_count <= #1  161'b0;
      p2_e1_delay_count <= #1  10'b0;
    end
    else begin
      p2_e1_status_state <= #1  p2_e1_state_next;
  ...
  always_ff @ (posedge clk) begin
    if (reset) begin
      ...
      p2_e1_last_read_data_val <= #1  32'b0;
    end
    else begin
      ...
      p2_e1_last_read_data_val <= #1  p2_e1_last_read_data_val_next;
    end
  end
  ...
  always_comb begin
    ...
    h2d_primary_ack =  1'b0;
    h2d_primary_nack =  1'b0;
    ...
    case (r16_primary_state)
      3'h0: begin // IDLE
          ...
          if (d2h_primary_re | d2h_primary_we) begin
            r16_primary_cmdValid_dly0 =  1'b1;
            r16_primary_cmdData_dly0[7] = d2h_primary_we;
      ...
      3'h1: begin // CMD_ADDR
          r16_primary_cmdValid_dly0 =  1'b1;
          r16_primary_cmdData_dly0 = {13'h1, d2h_primary_addr};
          if (d2h_primary_we) r16_primary_state_next = 3'h2;
      ...
      3'h2: begin // CMD_DATA
          ...
          if (r16_primary_data_cnt == 1'd0)
            r16_primary_cmdData_dly0 = d2h_primary_w [15:0] ;
          else if (r16_primary_data_cnt == 1'd1)
            r16_primary_cmdData_dly0 = d2h_primary_w [31:16] ;
          if (r16_primary_data_cnt == 1'b1)
            r16_primary_state_next = 3'h3;
        end
      3'h3: begin  // RES_WAIT
          if (r16_primary_resValid_dly1) begin
            if (d2h_primary_re & r16_primary_resData_dly1[14] & ~r16_primary_resData_dly1[15]) r16_primary_state_next = 3'h4;
  ...
  always_ff @ (posedge clk) begin
    if (reset) begin
      d2h_primary_we <= #1  1'b0;
      d2h_primary_re <= #1  1'b0;
    end
    else begin
      d2h_primary_w <= #1  d2h_primary_w_next;
      d2h_primary_we <= #1  d2h_primary_we_next & ~h2d_primary_ack & ~h2d_primary_nack;
      d2h_primary_re <= #1  d2h_primary_re_next & ~h2d_primary_ack & ~h2d_primary_nack;
      d2h_primary_addr <= #1  d2h_primary_addr_next;
    end
  end
  ...
  always_comb begin
    ...
    4'b1???:
      begin
        ...
        pio_external_ack_next = h2d_primary_ack;
        ...
        pio_external_nack_next = h2d_primary_nack;
        dec_pio_read_data_next  [31:0]  = h2d_primary_r;
      end
    endcase
  end
