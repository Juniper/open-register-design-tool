//   Ordt 161010.01 autogenerated file 
//   Input: ./rdl_sec_if/test.rdl
//   Parms: ./rdl_sec_if/test.parms
//   Date: Mon Oct 10 10:29:49 EDT 2016
//
...
(
  ...
  p2_e1_status_nack_error_w,
  p2_e1_status_bad_address_error_w,
  ...
  output    p2_e1_status_nack_error_w;
  output    p2_e1_status_bad_address_error_w;
  ...
  logic  p2_e1_status_nack_error_w;
  logic  p2_e1_status_bad_address_error_w;
  ...
  always_comb begin
    ...
    p2_e1_status_nack_error_w =  1'b0;
    p2_e1_status_bad_address_error_w =  1'b0;
          ...
          if (p2_dec_pio_ack) begin
            ...
            if (p2_e1_cntl_force_stop_r) begin
              ...
              if (p2_e1_cfg_stop_on_count_r && (p2_e1_trans_count_next == {1'b0,p2_e1_max_trans_count_val_r}))
                ...
                p2_e1_state_next = 3'h0;
                p2_e1_status_bad_address_error_w =  1'b1;
              end
              else begin
                p2_e1_state_next = 3'h1;
              end
            ...
            p2_e1_state_next = 3'h0;
            p2_e1_status_nack_error_w =  1'b1;
          end
          else begin
            p2_pio_dec_read_next =  1'b1;
            p2_arb_atomic_request_next =  (p2_e1_cfg_mode_r == 2'h2);
