...
class ordt_rg_primary_base_regs_config_regs : public ordt_reg {
  public:
    ordt_field<uint32_t> lsb_field;
    ordt_field<uint32_t> msb_field;
    ordt_rg_primary_base_regs_config_regs(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rset_primary_base_regs : public ordt_regset {
  public:
    ordt_addr_elem_array<ordt_rg_primary_base_regs_config_regs> config_regs;
    ordt_rset_primary_base_regs(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual void update_child_ptrs();
};

class ordt_rset_primary : public ordt_regset {
  public:
    ordt_rset_primary_base_regs base_regs;
    ordt_rset_primary(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual void update_child_ptrs();
};
