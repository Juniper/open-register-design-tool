//   Ordt 180322.01 autogenerated file 
//   Date: Thu Mar 22 15:58:56 EDT 2018
//
...
`ifndef ORDT_UVM_REG_PKG_SV
  ...
  package ordt_uvm_reg_pkg;
    ...
    class uvm_reg_field_mimic;
      ...
      function uvm_data_t get();
        return m_parent.get_field(m_name);
      endfunction: get
      
      /* Set field data in this reg's storage location. */
      function set(uvm_data_t value);
        m_parent.set_field(m_name, value);
      endfunction: set
