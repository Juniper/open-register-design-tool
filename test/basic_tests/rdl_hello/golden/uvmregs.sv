...
//   Date: Wed Jul 13 12:57:13 EDT 2016
//
...
class reg_foo_bar_a_reg extends uvm_reg_rdl;
  ...
  virtual function void build();
    ...
    this.fld2.configure(this, 1, 15, "RW", 0, 0, 0, 1, 0);
...
class block_foo extends uvm_reg_block_rdl;
  ...
  virtual function void build();
    ...
    this.set_rdl_address_map_hdl_path({`FOO_PIO_INSTANCE_PATH, ".jrdl_logic"});
    ...
    set_hdl_path_root({`FOO_PIO_INSTANCE_PATH, ".jrdl_logic"});
    this.add_callbacks();
  endfunction: build
