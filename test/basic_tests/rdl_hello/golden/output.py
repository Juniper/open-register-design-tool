...
class ordt_drv_root(ordt_drv_regset):
    ...
    def build(self):
        a_reg_5 = ordt_drv_reg('a_reg', 32)
        a_reg_5.add_field('fld1', 0, 10, True, True, 0)
        a_reg_5.add_field('fld2', 15, 1, True, True, None)
        a_reg_5.add_field('ERR25', 25, 1, True, True, 1)
        bar_4 = ordt_drv_regset('bar')
        bar_4.add_child(1, a_reg_5, 2, 0, 4)
        foo_3 = ordt_drv_regset('foo')
        foo_3.add_child(1, bar_4, 1, 0, 8)
