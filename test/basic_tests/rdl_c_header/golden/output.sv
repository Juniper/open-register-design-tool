...
(
  ...
  //------- reg defines
  logic   [7:0] rg_r0_f0;
  logic   [7:0] reg_r0_f0_next;
  logic   [7:0] l2h_r0_f0_r;
  logic   [7:0] rg_r0_f1;
  logic   [7:0] reg_r0_f1_next;
  logic   [7:0] l2h_r0_f1_r;
  logic   [15:0] rg_r0_f2;
  logic   [15:0] reg_r0_f2_next;
  logic   [15:0] l2h_r0_f2_r;
  logic   [31:0] l2d_r0_r;
  logic   [3:0] rg_r1_f0;
  logic   [3:0] reg_r1_f0_next;
  logic   [3:0] l2h_r1_f0_r;
  logic   [3:0] rg_r1_f1;
  logic   [3:0] reg_r1_f1_next;
  logic   [3:0] l2h_r1_f1_r;
  logic   [31:0] l2d_r1_r;
  logic   [1:0] rg_r2_f0;
  logic   [1:0] reg_r2_f0_next;
  logic   [1:0] l2h_r2_f0_r;
  logic   [1:0] rg_r2_f2;
  logic   [1:0] reg_r2_f2_next;
  logic   [1:0] l2h_r2_f2_r;
  logic   [3:0] rg_r2_f3;
  logic   [3:0] reg_r2_f3_next;
  logic   [3:0] l2h_r2_f3_r;
  logic   [31:0] l2d_r2_r;
