...
class ordt_drv_root(ordt_drv_regset):
    ...
    def build(self):
        r0_5 = ordt_drv_reg('r0', 32)
        r0_5.add_field('f0', 0, 8, True, True, 2)
        r0_5.add_field('f1', 8, 8, True, True, 4)
        r0_5.add_field('f2', 16, 16, True, True, 2571)
        r1_6 = ordt_drv_reg('r1', 32)
        r1_6.add_field('f0', 0, 4, True, True, 1)
        r1_6.add_field('f1', 4, 4, True, True, 0)
        r2_7 = ordt_drv_reg('r2', 32)
        r2_7.add_field('f2', 0, 2, True, True, 1)
        r2_7.add_field('f0', 2, 2, True, True, 1)
        r2_7.add_field('f3', 4, 4, True, True, 0)
        example_addr_map_4 = ordt_drv_regset('example_addr_map')
        example_addr_map_4.add_child(1, r0_5, 1, 0, 4)
        example_addr_map_4.add_child(1, r1_6, 1, 4, 4)
        example_addr_map_4.add_child(1, r2_7, 1, 8, 4)
        self.add_child(1, example_addr_map_4, 1, 0, 0)
