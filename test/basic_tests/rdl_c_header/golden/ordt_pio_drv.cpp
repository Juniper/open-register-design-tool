...
//   Date: Thu Jul 20 12:53:14 EDT 2023
//
...
int  ordt_drv_element::get_version(const std::string tag) {
  if (tag == "example_addr_map") return 0;
  else return -1;
}
...
std::vector<std::string>  ordt_drv_element::get_tags() {
  ...
  tags.push_back("example_addr_map");
  return tags;
}
...
void  ordt_drv_root::build() {
  std::shared_ptr<ordt_drv_reg> r0_1 = std::make_shared<ordt_drv_reg>("r0");
  r0_1->add_field("f0", 0, 8, true, true);
  r0_1->add_field("f1", 8, 8, true, true);
  r0_1->add_field("f2", 16, 16, true, true);
  std::shared_ptr<ordt_drv_reg> r1_2 = std::make_shared<ordt_drv_reg>("r1");
  r1_2->add_field("f0", 0, 4, true, true);
  r1_2->add_field("f1", 4, 4, true, true);
  std::shared_ptr<ordt_drv_reg> r2_3 = std::make_shared<ordt_drv_reg>("r2");
  r2_3->add_field("f2", 0, 2, true, true);
  r2_3->add_field("f0", 2, 2, true, true);
  r2_3->add_field("f3", 4, 4, true, true);
  std::shared_ptr<ordt_drv_regset> example_addr_map_0 = std::make_shared<ordt_drv_regset>("example_addr_map");
  example_addr_map_0->add_child(1, r0_1, 1, 0, 4);
  example_addr_map_0->add_child(1, r1_2, 1, 4, 4);
  example_addr_map_0->add_child(1, r2_3, 1, 8, 4);
  add_child(1, example_addr_map_0, 1, 0, 0);
}
