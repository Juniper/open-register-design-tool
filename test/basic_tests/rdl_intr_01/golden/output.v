...
//   Date: Fri Aug 12 23:22:59 EDT 2016
//
...
(
  ...
  always @ (*) begin
    ...
    if (d2l_bar_intr_reg1_we) reg_bar_intr_reg1_int1_next = (rg_bar_intr_reg1_int1 & ~d2l_bar_intr_reg1_w [0] );
    if (d2l_bar_intr_reg1_we) reg_bar_intr_reg1_int2_next = (rg_bar_intr_reg1_int2 & ~d2l_bar_intr_reg1_w [1] );
  end
  ...
  always @ (*) begin
    ...
    if (d2l_bar_sub_intr_reg2_we) reg_bar_sub_intr_reg2_int1_next = (rg_bar_sub_intr_reg2_int1 & ~d2l_bar_sub_intr_reg2_w [0] );
    if (d2l_bar_sub_intr_reg2_we) reg_bar_sub_intr_reg2_int2_next = (rg_bar_sub_intr_reg2_int2 & ~d2l_bar_sub_intr_reg2_w [1] );
  end
  ...
  always @ (*) begin
    ...
    if (d2l_bar_sub_intr_reg3_we) reg_bar_sub_intr_reg3_int1_next = (rg_bar_sub_intr_reg3_int1 & ~d2l_bar_sub_intr_reg3_w [0] );
    if (d2l_bar_sub_intr_reg3_we) reg_bar_sub_intr_reg3_int2_next = (rg_bar_sub_intr_reg3_int2 & ~d2l_bar_sub_intr_reg3_w [1] );
  end
