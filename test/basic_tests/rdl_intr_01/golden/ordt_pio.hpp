...
class ordt_rg_bar_a_reg : public ordt_reg {
  public:
    ordt_field<uint32_t> fld1;
    ordt_field<uint_fast8_t> fld2;
    ordt_rg_bar_a_reg(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_bar_intr_reg1 : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> int1;
    ordt_field<uint_fast8_t> int2;
    ordt_rg_bar_intr_reg1(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_bar_log_reg1 : public ordt_reg {
  public:
    ordt_field<uint32_t> err_log;
    ordt_rg_bar_log_reg1(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_bar_log_reg2 : public ordt_reg {
  public:
    ordt_field<uint32_t> err_log;
    ordt_rg_bar_log_reg2(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_bar_log_reg3 : public ordt_reg {
  public:
    ordt_field<uint32_t> err_log;
    ordt_rg_bar_log_reg3(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_bar_sub_intr_reg2 : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> int1;
    ordt_field<uint_fast8_t> int2;
    ordt_rg_bar_sub_intr_reg2(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_bar_sub_intr_reg3 : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> int1;
    ordt_field<uint_fast8_t> int2;
    ordt_rg_bar_sub_intr_reg3(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rset_bar_sub : public ordt_regset {
  public:
    ordt_rg_bar_sub_intr_reg2 intr_reg2;
    ordt_rg_bar_sub_intr_reg3 intr_reg3;
    ordt_rset_bar_sub(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual void update_child_ptrs();
};

class ordt_rg_bar_rst_reg : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> fld2;
    ordt_field<uint_fast8_t> fld1;
    ordt_field<uint_fast8_t> fld3;
    ordt_field<uint_fast8_t> fld4;
    ordt_rg_bar_rst_reg(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_bar_negintr : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> interrupt;
    ordt_rg_bar_negintr(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_bar_bothintr : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> interrupt;
    ordt_rg_bar_bothintr(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rset_bar : public ordt_regset {
  public:
    ordt_addr_elem_array<ordt_rg_bar_a_reg> a_reg;
    ordt_rg_bar_intr_reg1 intr_reg1;
    ordt_rg_bar_log_reg1 log_reg1;
    ordt_rg_bar_log_reg2 log_reg2;
    ordt_rg_bar_log_reg3 log_reg3;
    ordt_rset_bar_sub sub;
    ordt_rg_bar_rst_reg rst_reg;
    ordt_rg_bar_negintr negintr;
    ordt_rg_bar_bothintr bothintr;
    ordt_rset_bar(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual void update_child_ptrs();
};

class ordt_rg_intr_cascade_merge : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> fld1;
    ordt_field<uint_fast8_t> fld2;
    ordt_rg_intr_cascade_merge(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rset_intr_cascade : public ordt_regset {
  public:
    ordt_rg_intr_cascade_merge merge;
    ordt_rset_intr_cascade(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual void update_child_ptrs();
};
...
class ordt_root : public ordt_regset {
  public:
    ordt_rset_bar bar;
    ordt_rset_intr_cascade intr_cascade;
    ordt_root();
