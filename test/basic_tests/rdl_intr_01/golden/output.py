...
class ordt_drv_root(ordt_drv_regset):
    ...
    def build(self):
        merge_29 = ordt_drv_reg('merge', 32)
        merge_29.add_field('fld1', 0, 1, True, False, 0)
        merge_29.add_field('fld2', 1, 1, True, False, 0)
        intr_cascade_28 = ordt_drv_regset('intr_cascade')
        intr_cascade_28.add_child(1, merge_29, 1, 0, 4)
        intr_reg1_18 = ordt_drv_reg('intr_reg1', 32)
        intr_reg1_18.add_field('int1', 0, 1, True, True, 0)
        intr_reg1_18.add_field('int2', 1, 1, True, True, 0)
        log_reg1_19 = ordt_drv_reg('log_reg1', 32)
        log_reg1_19.add_field('err_log', 0, 10, True, True, 0)
        log_reg2_20 = ordt_drv_reg('log_reg2', 32)
        log_reg2_20.add_field('err_log', 0, 10, True, True, 0)
        negintr_26 = ordt_drv_reg('negintr', 32)
        negintr_26.add_field('interrupt', 0, 1, True, True, 0)
        rst_reg_25 = ordt_drv_reg('rst_reg', 32)
        rst_reg_25.add_field('fld2', 0, 4, True, True, 2)
        rst_reg_25.add_field('fld1', 4, 4, True, True, 1)
        rst_reg_25.add_field('fld3', 8, 3, True, True, 3)
        rst_reg_25.add_field('fld4', 11, 3, True, True, 4)
        a_reg_17 = ordt_drv_reg('a_reg', 32)
        a_reg_17.add_field('fld1', 0, 10, True, True, 0)
        a_reg_17.add_field('fld2', 15, 1, True, True, None)
        log_reg3_21 = ordt_drv_reg('log_reg3', 32)
        log_reg3_21.add_field('err_log', 0, 10, True, True, 0)
        intr_reg3_24 = ordt_drv_reg('intr_reg3', 32)
        intr_reg3_24.add_field('int1', 0, 1, True, True, 0)
        intr_reg3_24.add_field('int2', 1, 1, True, True, 0)
        intr_reg2_23 = ordt_drv_reg('intr_reg2', 32)
        intr_reg2_23.add_field('int1', 0, 1, True, True, 0)
        intr_reg2_23.add_field('int2', 1, 1, True, True, 0)
        sub_22 = ordt_drv_regset('sub')
        sub_22.add_child(1, intr_reg3_24, 1, 256, 4)
        sub_22.add_child(1, intr_reg2_23, 1, 0, 4)
        bothintr_27 = ordt_drv_reg('bothintr', 32)
        bothintr_27.add_field('interrupt', 0, 1, True, True, 0)
        bar_16 = ordt_drv_regset('bar')
        bar_16.add_child(1, intr_reg1_18, 1, 256, 4)
        bar_16.add_child(1, log_reg1_19, 1, 260, 4)
        bar_16.add_child(1, log_reg2_20, 1, 264, 4)
        bar_16.add_child(1, negintr_26, 1, 1280, 4)
        bar_16.add_child(1, rst_reg_25, 1, 772, 4)
        bar_16.add_child(1, a_reg_17, 2, 0, 4)
        bar_16.add_child(1, log_reg3_21, 1, 268, 4)
        bar_16.add_child(1, sub_22, 1, 512, 512)
        bar_16.add_child(1, bothintr_27, 1, 1284, 4)
        foo_15 = ordt_drv_regset('foo')
        foo_15.add_child(1, intr_cascade_28, 1, 4096, 4)
        foo_15.add_child(1, bar_16, 1, 0, 2048)
        self.add_child(1, foo_15, 1, 0, 0)
