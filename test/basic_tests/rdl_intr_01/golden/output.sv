//   Ordt 191123.01 autogenerated file 
//   Input: ./rdl_intr_01/test.rdl
//   Parms: ./rdl_intr_01/test.parms
//   Date: Sat Nov 23 13:56:59 EST 2019
//
...
(
  ...
  covergroup interrupt_cg @(posedge clk);
    h2l_bar_intr_reg1_int1_intr: coverpoint h2l_bar_intr_reg1_int1_intr iff(!reset);
    h2l_bar_intr_reg1_int2_intr: coverpoint h2l_bar_intr_reg1_int2_intr iff(!reset);
    h2l_bar_sub_intr_reg2_int1_intr: coverpoint h2l_bar_sub_intr_reg2_int1_intr iff(!reset);
    h2l_bar_sub_intr_reg2_int2_intr: coverpoint h2l_bar_sub_intr_reg2_int2_intr iff(!reset);
    h2l_bar_sub_intr_reg3_int1_intr: coverpoint h2l_bar_sub_intr_reg3_int1_intr iff(!reset);
    h2l_bar_sub_intr_reg3_int2_intr: coverpoint h2l_bar_sub_intr_reg3_int2_intr iff(!reset);
    h2l_bar_negintr_interrupt_intr: coverpoint h2l_bar_negintr_interrupt_intr iff(!reset);
    h2l_bar_bothintr_interrupt_intr: coverpoint h2l_bar_bothintr_interrupt_intr iff(!reset);
    h2l_intr_cascade_merge_fld2_intr: coverpoint h2l_intr_cascade_merge_fld2_intr iff(!reset);
  endgroup
  
  interrupt_cg interrupt_cg_inst = new();
