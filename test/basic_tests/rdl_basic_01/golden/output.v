//   Ordt 190606.01 autogenerated file 
//   Input: ./rdl_basic_01/test.rdl
//   Parms: ./rdl_basic_01/test.parms
//   Date: Thu Jun 06 13:30:54 EDT 2019
//
...
(
  ...
  //------- reg assigns for external i/f (reset signal = reset)
  always @ (posedge clk) begin
    if (reset) begin
  ...
  //------- reg assigns for pio i/f (reset signal = reset)
  always @ (posedge clk) begin
    if (reset) begin
