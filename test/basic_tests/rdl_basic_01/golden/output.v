...
//   Date: Mon Sep 12 15:23:59 EDT 2016
//
...
(
  ...
  reg   [31:0] d2h_rdr_cp_fp_wr_w;
  reg  d2h_rdr_cp_fp_wr_we;
  reg  d2h_rdr_cp_fp_wr_re;
  reg   [31:0] d2h_rdr_cp_fp_wr_w_next;
  reg  d2h_rdr_cp_fp_wr_we_next;
  reg  d2h_rdr_cp_fp_wr_re_next;
  reg   [3:2] d2h_rdr_cp_fp_wr_addr;
  ...
  always @ (posedge clk) begin
    if (reset) begin
      d2h_rdr_cp_fp_wr_we <= #1  1'b0;
      d2h_rdr_cp_fp_wr_re <= #1  1'b0;
    end
    else begin
      d2h_rdr_cp_fp_wr_w <= #1  d2h_rdr_cp_fp_wr_w_next;
      d2h_rdr_cp_fp_wr_we <= #1  d2h_rdr_cp_fp_wr_we_next & ~h2d_rdr_cp_fp_wr_ack & ~h2d_rdr_cp_fp_wr_nack;
      d2h_rdr_cp_fp_wr_re <= #1  d2h_rdr_cp_fp_wr_re_next & ~h2d_rdr_cp_fp_wr_ack & ~h2d_rdr_cp_fp_wr_nack;
      d2h_rdr_cp_fp_wr_addr <= #1  d2h_rdr_cp_fp_wr_addr_next;
    end
  end
  ...
  always @ (*) begin
    ...
    13'b11000011100??:
      begin
        ...
        pio_external_ack_next = h2d_rdr_cp_fp_wr_ack;
        ...
        pio_external_nack_next = h2d_rdr_cp_fp_wr_nack;
        dec_pio_read_data_next  [31:0]  = h2d_rdr_cp_fp_wr_r;
      end
