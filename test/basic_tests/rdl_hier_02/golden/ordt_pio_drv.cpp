...
void  ordt_drv_root::build() {
  std::shared_ptr<ordt_drv_reg> sing_reg_50 = std::make_shared<ordt_drv_reg>("sing_reg");
  sing_reg_50->add_field("lsb_field", 0, 16, true, true);
  sing_reg_50->add_field("msb_field", 16, 16, true, true);
  std::shared_ptr<ordt_drv_regset> singleton_rf_s8_49 = std::make_shared<ordt_drv_regset>("singleton_rf_s8");
  singleton_rf_s8_49->add_child(1, sing_reg_50, 1, 0, 4);
  std::shared_ptr<ordt_drv_regset> singleton_rf_dflt_53 = std::make_shared<ordt_drv_regset>("singleton_rf_dflt");
  singleton_rf_dflt_53->add_child(1, sing_reg_50, 1, 0, 4);
  ...
  std::shared_ptr<ordt_drv_regset> singleton_rf_r16_51 = std::make_shared<ordt_drv_regset>("singleton_rf_r16");
  singleton_rf_r16_51->add_child(1, sing_reg_50, 1, 0, 4);
  std::shared_ptr<ordt_drv_reg> reg_dflt_57 = std::make_shared<ordt_drv_reg>("reg_dflt");
  reg_dflt_57->add_field("lsb_field", 0, 16, true, true);
  reg_dflt_57->add_field("msb_field", 16, 16, true, true);
  std::shared_ptr<ordt_drv_reg> reg_l2_59 = std::make_shared<ordt_drv_reg>("reg_l2");
  reg_l2_59->add_field("lsb_field", 0, 16, true, true);
  reg_l2_59->add_field("msb_field", 16, 16, true, true);
  std::shared_ptr<ordt_drv_reg> reg_l1_58 = std::make_shared<ordt_drv_reg>("reg_l1");
  reg_l1_58->add_field("lsb_field", 0, 16, true, true);
  reg_l1_58->add_field("msb_field", 16, 16, true, true);
  std::shared_ptr<ordt_drv_regset> rf_lvl1_56 = std::make_shared<ordt_drv_regset>("rf_lvl1");
  rf_lvl1_56->add_child(1, reg_dflt_57, 1, 0, 4);
  rf_lvl1_56->add_child(1, reg_l2_59, 1, 16, 4);
  rf_lvl1_56->add_child(1, reg_l1_58, 1, 8, 4);
  std::shared_ptr<ordt_drv_regset> rf_lvl2_55 = std::make_shared<ordt_drv_regset>("rf_lvl2");
  rf_lvl2_55->add_child(1, rf_lvl1_56, 4, 0, 32);
  std::shared_ptr<ordt_drv_regset> l2_dflt_child_35 = std::make_shared<ordt_drv_regset>("l2_dflt_child");
  l2_dflt_child_35->add_child(1, ext_base_regs_4, 1, 4096, 512);
  l2_dflt_child_35->add_child(1, base_regs_1, 1, 0, 512);
  l2_dflt_child_35->add_child(1, l3_child_14, 1, 8192, 4096);
  std::shared_ptr<ordt_drv_regset> base_map_0 = std::make_shared<ordt_drv_regset>("base_map");
  base_map_0->add_child(1, singleton_rf_s8_49, 1, 327680, 4);
  base_map_0->add_child(1, singleton_rf_dflt_53, 1, 458752, 4);
  base_map_0->add_child(1, l2_r16_child_7, 1, 131072, 16384);
  base_map_0->add_child(1, l2_s8_child_21, 1, 196608, 16384);
  base_map_0->add_child(1, singleton_rf_r16_51, 1, 393216, 4);
  base_map_0->add_child(1, base_regs_1, 1, 0, 512);
  base_map_0->add_child(1, ext_base_regs_4, 1, 65536, 512);
  base_map_0->add_child(1, rf_lvl2_55, 2, 524288, 512);
  base_map_0->add_child(1, l2_dflt_child_35, 1, 262144, 16384);
