//   Ordt 160812.02 autogenerated file 
//   Input: ./rdl_hier_02/test.rdl
//   Parms: ./rdl_hier_02/test.parms
//   Date: Fri Aug 12 23:22:58 EDT 2016
//
...
(
  ...
  always_ff @ (posedge uclk) begin
    if (reset) begin
      ...
      pio_dec_read_cgate_dly2 <= #1 pio_dec_read_cgate_dly1;
      pio_dec_write_cgate_dly2 <= #1 pio_dec_write_cgate_dly1;
      pio_dec_read_cgate_dly3 <= #1 pio_dec_read_cgate_dly2;
      pio_dec_write_cgate_dly3 <= #1 pio_dec_write_cgate_dly2;
      pio_dec_read_cgate_dly4 <= #1 pio_dec_read_cgate_dly3;
      pio_dec_write_cgate_dly4 <= #1 pio_dec_write_cgate_dly3;
      pio_dec_read_cgate_dly5 <= #1 pio_dec_read_cgate_dly4;
      pio_dec_write_cgate_dly5 <= #1 pio_dec_write_cgate_dly4;
      pio_dec_read_cgate_dly6 <= #1 pio_dec_read_cgate_dly5;
      pio_dec_write_cgate_dly6 <= #1 pio_dec_write_cgate_dly5;
    end
  end
