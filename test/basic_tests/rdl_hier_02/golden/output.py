...
class ordt_drv_root(ordt_drv_regset):
    ...
    def build(self):
        sing_reg_110 = ordt_drv_reg('sing_reg', 32)
        sing_reg_110.add_field('lsb_field', 0, 16, True, True, 65535)
        sing_reg_110.add_field('msb_field', 16, 16, True, True, 0)
        singleton_rf_s8_109 = ordt_drv_regset('singleton_rf_s8')
        singleton_rf_s8_109.add_child(1, sing_reg_110, 1, 0, 4)
        singleton_rf_dflt_113 = ordt_drv_regset('singleton_rf_dflt')
        singleton_rf_dflt_113.add_child(1, sing_reg_110, 1, 0, 4)
        config_regs_62 = ordt_drv_reg('config_regs', 32)
        config_regs_62.add_field('lsb_field', 0, 16, True, True, 65535)
        config_regs_62.add_field('msb_field', 16, 16, True, True, 0)
        state_regs_63 = ordt_drv_reg('state_regs', 32)
        state_regs_63.add_field('lsb_field', 0, 16, True, False, 65535)
        ext_base_regs_64 = ordt_drv_regset('ext_base_regs')
        ext_base_regs_64.add_child(1, config_regs_62, 8, 0, 4)
        ext_base_regs_64.add_child(1, state_regs_63, 8, 256, 4)
        base_regs_61 = ordt_drv_regset('base_regs')
        base_regs_61.add_child(1, config_regs_62, 8, 0, 4)
        base_regs_61.add_child(1, state_regs_63, 8, 256, 4)
        l3_child_74 = ordt_drv_regset('l3_child')
        l3_child_74.add_child(1, base_regs_61, 1, 0, 512)
        l3_child_74.add_child(1, ext_base_regs_64, 1, 2048, 512)
        l2_r16_child_67 = ordt_drv_regset('l2_r16_child')
        l2_r16_child_67.add_child(1, ext_base_regs_64, 1, 4096, 512)
        l2_r16_child_67.add_child(1, base_regs_61, 1, 0, 512)
        l2_r16_child_67.add_child(1, l3_child_74, 1, 8192, 4096)
        l2_s8_child_81 = ordt_drv_regset('l2_s8_child')
        l2_s8_child_81.add_child(1, ext_base_regs_64, 1, 4096, 512)
        l2_s8_child_81.add_child(1, base_regs_61, 1, 0, 512)
        l2_s8_child_81.add_child(1, l3_child_74, 1, 8192, 4096)
        singleton_rf_r16_111 = ordt_drv_regset('singleton_rf_r16')
        singleton_rf_r16_111.add_child(1, sing_reg_110, 1, 0, 4)
        reg_dflt_117 = ordt_drv_reg('reg_dflt', 32)
        reg_dflt_117.add_field('lsb_field', 0, 16, True, True, 65535)
        reg_dflt_117.add_field('msb_field', 16, 16, True, True, 0)
        reg_l2_119 = ordt_drv_reg('reg_l2', 32)
        reg_l2_119.add_field('lsb_field', 0, 16, True, True, 65535)
        reg_l2_119.add_field('msb_field', 16, 16, True, True, 0)
        reg_l1_118 = ordt_drv_reg('reg_l1', 32)
        reg_l1_118.add_field('lsb_field', 0, 16, True, True, 65535)
        reg_l1_118.add_field('msb_field', 16, 16, True, True, 0)
        rf_lvl1_116 = ordt_drv_regset('rf_lvl1')
        rf_lvl1_116.add_child(1, reg_dflt_117, 1, 0, 4)
        rf_lvl1_116.add_child(1, reg_l2_119, 1, 16, 4)
        rf_lvl1_116.add_child(1, reg_l1_118, 1, 8, 4)
        rf_lvl2_115 = ordt_drv_regset('rf_lvl2')
        rf_lvl2_115.add_child(1, rf_lvl1_116, 4, 0, 32)
        l2_dflt_child_95 = ordt_drv_regset('l2_dflt_child')
        l2_dflt_child_95.add_child(1, ext_base_regs_64, 1, 4096, 512)
        l2_dflt_child_95.add_child(1, base_regs_61, 1, 0, 512)
        l2_dflt_child_95.add_child(1, l3_child_74, 1, 8192, 4096)
        base_map_60 = ordt_drv_regset('base_map')
        base_map_60.add_child(1, singleton_rf_s8_109, 1, 327680, 4)
        base_map_60.add_child(1, singleton_rf_dflt_113, 1, 458752, 4)
        base_map_60.add_child(1, l2_r16_child_67, 1, 131072, 16384)
        base_map_60.add_child(1, l2_s8_child_81, 1, 196608, 16384)
        base_map_60.add_child(1, singleton_rf_r16_111, 1, 393216, 4)
        base_map_60.add_child(1, base_regs_61, 1, 0, 512)
        base_map_60.add_child(1, ext_base_regs_64, 1, 65536, 512)
        base_map_60.add_child(1, rf_lvl2_115, 2, 524288, 512)
        base_map_60.add_child(1, l2_dflt_child_95, 1, 262144, 16384)
        self.add_child(1, base_map_60, 1, 0, 0)
