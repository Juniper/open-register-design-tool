...
void  ordt_drv_root::build() {
  std::shared_ptr<ordt_drv_reg> wrap_info_reg_7 = std::make_shared<ordt_drv_reg>("wrap_info_reg");
  wrap_info_reg_7->add_field("bar1", 0, 1, true, true);
  wrap_info_reg_7->add_field("bar2", 1, 1, true, true);
  wrap_info_reg_7->add_field("bar3", 2, 1, true, true);
  std::shared_ptr<ordt_drv_reg> reg_none_2 = std::make_shared<ordt_drv_reg>("reg_none");
  reg_none_2->add_field("fld_none", 0, 1, true, true);
  reg_none_2->add_field("fld_gen", 1, 1, true, true);
  reg_none_2->add_field("fld_ext", 2, 1, true, true);
  reg_none_2->add_field("fld_int", 3, 1, true, true);
  std::shared_ptr<ordt_drv_reg> reg_int_3 = std::make_shared<ordt_drv_reg>("reg_int");
  reg_int_3->add_field("fld_none", 0, 1, true, true);
  reg_int_3->add_field("fld_gen", 1, 1, true, true);
  reg_int_3->add_field("fld_ext", 2, 1, true, true);
  reg_int_3->add_field("fld_int", 3, 1, true, true);
  std::shared_ptr<ordt_drv_regset> regs_none_1 = std::make_shared<ordt_drv_regset>("regs_none");
  regs_none_1->add_child(1, reg_none_2, 1, 0, 4);
  regs_none_1->add_child(1, reg_int_3, 1, 4, 4);
  std::shared_ptr<ordt_drv_regset> regs_ext_4 = std::make_shared<ordt_drv_regset>("regs_ext");
  regs_ext_4->add_child(1, reg_none_2, 1, 0, 4);
  regs_ext_4->add_child(1, reg_int_3, 1, 4, 4);
  std::shared_ptr<ordt_drv_regset> top_0 = std::make_shared<ordt_drv_regset>("top");
  top_0->add_child(1, wrap_info_reg_7, 1, 512, 4);
  top_0->add_child(1, regs_none_1, 1, 0, 8);
  top_0->add_child(1, regs_ext_4, 1, 8, 8);
