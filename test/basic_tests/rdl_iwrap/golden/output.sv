//   Ordt 160825.01 autogenerated file 
//   Input: ./rdl_iwrap/test.rdl
//   Parms: ./rdl_iwrap/test.parms
//   Date: Thu Aug 25 22:13:57 EDT 2016
//
...
module top_pio_iwrap
  ...
  //------- wire defines
  logic  h2l_regs_none_reg_none_fld_gen_w;
  logic  h2l_regs_none_reg_none_fld_gen_we;
  logic  h2l_regs_none_reg_none_fld_ext_w;
  logic  h2l_regs_none_reg_none_fld_ext_we;
  logic  h2l_regs_none_reg_none_fld_int_w;
  logic  h2l_regs_none_reg_none_fld_int_we;
  logic  h2l_regs_none_reg_int_fld_none_w;
  logic  h2l_regs_none_reg_int_fld_none_we;
  logic  h2l_regs_none_reg_int_fld_gen_w;
  logic  h2l_regs_none_reg_int_fld_gen_we;
  logic  h2l_regs_none_reg_int_fld_ext_w;
  logic  h2l_regs_none_reg_int_fld_ext_we;
  logic  h2l_regs_none_reg_int_fld_int_w;
  logic  h2l_regs_none_reg_int_fld_int_we;
  logic  l2h_regs_none_reg_none_fld_gen_r;
  logic  l2h_regs_none_reg_none_fld_ext_r;
  logic  l2h_regs_none_reg_none_fld_int_r;
  logic  l2h_regs_none_reg_int_fld_none_r;
  ...
  logic  l2h_regs_none_reg_int_fld_ext_r;
  logic  l2h_regs_none_reg_int_fld_int_r;
  logic  h2l_regs_ext_reg_none_fld_none_w;
  logic  h2l_regs_ext_reg_none_fld_none_we;
  logic  h2l_regs_ext_reg_none_fld_gen_w;
  logic  h2l_regs_ext_reg_none_fld_gen_we;
  logic  h2l_regs_ext_reg_none_fld_ext_w;
  logic  h2l_regs_ext_reg_none_fld_ext_we;
  logic  h2l_regs_ext_reg_none_fld_int_w;
  logic  h2l_regs_ext_reg_none_fld_int_we;
  logic  h2l_regs_ext_reg_int_fld_none_w;
  logic  h2l_regs_ext_reg_int_fld_none_we;
  logic  h2l_regs_ext_reg_int_fld_gen_w;
  logic  h2l_regs_ext_reg_int_fld_gen_we;
  logic  h2l_regs_ext_reg_int_fld_ext_w;
  logic  h2l_regs_ext_reg_int_fld_ext_we;
  logic  h2l_regs_ext_reg_int_fld_int_w;
  logic  h2l_regs_ext_reg_int_fld_int_we;
  logic  l2h_regs_ext_reg_none_fld_none_r;
  logic  l2h_regs_ext_reg_none_fld_gen_r;
  logic  l2h_regs_ext_reg_none_fld_ext_r;
  logic  l2h_regs_ext_reg_none_fld_int_r;
  ...
  //------- assigns
  assign  h2l_regs_none_reg_none_fld_gen_w = lh_regs_none_reg_none_fld_gen.w;
  assign  h2l_regs_none_reg_none_fld_gen_we = lh_regs_none_reg_none_fld_gen.we;
  assign  lh_regs_none_reg_none_fld_gen.r = l2h_regs_none_reg_none_fld_gen_r;
  assign  h2l_regs_none_reg_none_fld_ext_w = lh_regs_none_reg_none_fld_ext.w;
  assign  h2l_regs_none_reg_none_fld_ext_we = lh_regs_none_reg_none_fld_ext.we;
  assign  lh_regs_none_reg_none_fld_ext.r = l2h_regs_none_reg_none_fld_ext_r;
  assign  h2l_regs_none_reg_none_fld_int_w = lh_regs_none_reg_none_fld_int.w;
  assign  h2l_regs_none_reg_none_fld_int_we = lh_regs_none_reg_none_fld_int.we;
  assign  lh_regs_none_reg_none_fld_int.r = l2h_regs_none_reg_none_fld_int_r;
  assign  h2l_regs_none_reg_int_fld_none_w = lh_regs_none_reg_int.fld_none_w;
  assign  h2l_regs_none_reg_int_fld_none_we = lh_regs_none_reg_int.fld_none_we;
  assign  lh_regs_none_reg_int.fld_none_r = l2h_regs_none_reg_int_fld_none_r;
  assign  h2l_regs_none_reg_int_fld_gen_w = lh_regs_none_reg_int.fld_gen.w;
  assign  h2l_regs_none_reg_int_fld_gen_we = lh_regs_none_reg_int.fld_gen.we;
  assign  lh_regs_none_reg_int.fld_gen.r = l2h_regs_none_reg_int_fld_gen_r;
  assign  h2l_regs_none_reg_int_fld_ext_w = lh_regs_none_reg_int.fld_ext.w;
  assign  h2l_regs_none_reg_int_fld_ext_we = lh_regs_none_reg_int.fld_ext.we;
  assign  lh_regs_none_reg_int.fld_ext.r = l2h_regs_none_reg_int_fld_ext_r;
  assign  h2l_regs_none_reg_int_fld_int_w = lh_regs_none_reg_int.fld_int.w;
  assign  h2l_regs_none_reg_int_fld_int_we = lh_regs_none_reg_int.fld_int.we;
  assign  lh_regs_none_reg_int.fld_int.r = l2h_regs_none_reg_int_fld_int_r;
  assign  h2l_regs_ext_reg_none_fld_none_w = lh_regs_ext.reg_none_fld_none_w;
  assign  h2l_regs_ext_reg_none_fld_none_we = lh_regs_ext.reg_none_fld_none_we;
  assign  lh_regs_ext.reg_none_fld_none_r = l2h_regs_ext_reg_none_fld_none_r;
  assign  h2l_regs_ext_reg_none_fld_gen_w = lh_regs_ext.reg_none_fld_gen.w;
  assign  h2l_regs_ext_reg_none_fld_gen_we = lh_regs_ext.reg_none_fld_gen.we;
  assign  lh_regs_ext.reg_none_fld_gen.r = l2h_regs_ext_reg_none_fld_gen_r;
  assign  h2l_regs_ext_reg_none_fld_ext_w = lh_regs_ext.reg_none_fld_ext.w;
  assign  h2l_regs_ext_reg_none_fld_ext_we = lh_regs_ext.reg_none_fld_ext.we;
  assign  lh_regs_ext.reg_none_fld_ext.r = l2h_regs_ext_reg_none_fld_ext_r;
  assign  h2l_regs_ext_reg_none_fld_int_w = lh_regs_ext.reg_none_fld_int.w;
  assign  h2l_regs_ext_reg_none_fld_int_we = lh_regs_ext.reg_none_fld_int.we;
  assign  lh_regs_ext.reg_none_fld_int.r = l2h_regs_ext_reg_none_fld_int_r;
  assign  h2l_regs_ext_reg_int_fld_none_w = lh_regs_ext.reg_int.fld_none_w;
  assign  h2l_regs_ext_reg_int_fld_none_we = lh_regs_ext.reg_int.fld_none_we;
  assign  lh_regs_ext.reg_int.fld_none_r = l2h_regs_ext_reg_int_fld_none_r;
  assign  h2l_regs_ext_reg_int_fld_gen_w = lh_regs_ext.reg_int.fld_gen.w;
  assign  h2l_regs_ext_reg_int_fld_gen_we = lh_regs_ext.reg_int.fld_gen.we;
  assign  lh_regs_ext.reg_int.fld_gen.r = l2h_regs_ext_reg_int_fld_gen_r;
  assign  h2l_regs_ext_reg_int_fld_ext_w = lh_regs_ext.reg_int.fld_ext.w;
  assign  h2l_regs_ext_reg_int_fld_ext_we = lh_regs_ext.reg_int.fld_ext.we;
  assign  lh_regs_ext.reg_int.fld_ext.r = l2h_regs_ext_reg_int_fld_ext_r;
  assign  h2l_regs_ext_reg_int_fld_int_w = lh_regs_ext.reg_int.fld_int.w;
  assign  h2l_regs_ext_reg_int_fld_int_we = lh_regs_ext.reg_int.fld_int.we;
  assign  lh_regs_ext.reg_int.fld_int.r = l2h_regs_ext_reg_int_fld_int_r;
