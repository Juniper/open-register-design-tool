...
class ordt_rg_regs_none_reg_none : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> fld_none;
    ordt_field<uint_fast8_t> fld_gen;
    ordt_field<uint_fast8_t> fld_ext;
    ordt_field<uint_fast8_t> fld_int;
    ordt_rg_regs_none_reg_none(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_regs_none_reg_int : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> fld_none;
    ordt_field<uint_fast8_t> fld_gen;
    ordt_field<uint_fast8_t> fld_ext;
    ordt_field<uint_fast8_t> fld_int;
    ordt_rg_regs_none_reg_int(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rset_regs_none : public ordt_regset {
  public:
    ordt_rg_regs_none_reg_none reg_none;
    ordt_rg_regs_none_reg_int reg_int;
    ordt_rset_regs_none(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual void update_child_ptrs();
};

class ordt_rg_regs_ext_reg_none : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> fld_none;
    ordt_field<uint_fast8_t> fld_gen;
    ordt_field<uint_fast8_t> fld_ext;
    ordt_field<uint_fast8_t> fld_int;
    ordt_rg_regs_ext_reg_none(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_regs_ext_reg_int : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> fld_none;
    ordt_field<uint_fast8_t> fld_gen;
    ordt_field<uint_fast8_t> fld_ext;
    ordt_field<uint_fast8_t> fld_int;
    ordt_rg_regs_ext_reg_int(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rset_regs_ext : public ordt_regset {
  public:
    ordt_rg_regs_ext_reg_none reg_none;
    ordt_rg_regs_ext_reg_int reg_int;
    ordt_rset_regs_ext(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual void update_child_ptrs();
};

class ordt_rg_wrap_info_reg : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> bar1;
    ordt_field<uint_fast8_t> bar2;
    ordt_field<uint_fast8_t> bar3;
    ordt_rg_wrap_info_reg(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_root : public ordt_regset {
  public:
    ordt_rset_regs_none regs_none;
    ordt_rset_regs_ext regs_ext;
    ordt_rg_wrap_info_reg wrap_info_reg;
    ordt_root();
