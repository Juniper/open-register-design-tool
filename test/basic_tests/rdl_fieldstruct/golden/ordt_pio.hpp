...
class ordt_rg_areg : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> hier_fs_fs1_fld1;
    ordt_field<uint_fast8_t> hier_fs_fs1_fld2;
    ordt_field<uint_fast8_t> hier_fs_fld1;
    ordt_field<uint_fast8_t> hier_fs_fs2_fld1;
    ordt_field<uint_fast8_t> hier_fs_fs2_fld2;
    ordt_field<uint_fast8_t> fs3_fld1;
    ordt_field<uint_fast8_t> fs3_fld2;
    ordt_rg_areg(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_blabla : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> fs1_0_fld1;
    ordt_field<uint_fast8_t> fs1_0_fld2;
    ordt_field<uint_fast8_t> fs1_1_fld1;
    ordt_field<uint_fast8_t> fs1_1_fld2;
    ordt_field<uint_fast8_t> fs1_2_fld1;
    ordt_field<uint_fast8_t> fs1_2_fld2;
    ordt_field<uint_fast8_t> fs3_0_fld1;
    ordt_field<uint_fast8_t> fs3_0_fld2;
    ordt_field<uint_fast8_t> fs3_1_fld1;
    ordt_field<uint_fast8_t> fs3_1_fld2;
    ordt_rg_blabla(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_root : public ordt_regset {
  public:
    ordt_addr_elem_array<ordt_rg_areg> areg;
    ordt_rg_blabla blabla;
    ordt_root();
