...
void  ordt_drv_root::build() {
  std::shared_ptr<ordt_drv_reg> blabla_2 = std::make_shared<ordt_drv_reg>("blabla");
  blabla_2->add_field("fs1_0_fld1", 0, 4, true, true);
  blabla_2->add_field("fs1_0_fld2", 4, 1, true, true);
  blabla_2->add_field("fs1_1_fld1", 5, 4, true, true);
  blabla_2->add_field("fs1_1_fld2", 9, 1, true, true);
  blabla_2->add_field("fs1_2_fld1", 10, 4, true, true);
  blabla_2->add_field("fs1_2_fld2", 14, 1, true, true);
  blabla_2->add_field("fs3_0_fld1", 15, 4, true, true);
  blabla_2->add_field("fs3_0_fld2", 19, 1, true, true);
  blabla_2->add_field("fs3_1_fld1", 23, 4, true, true);
  blabla_2->add_field("fs3_1_fld2", 27, 1, true, true);
  std::shared_ptr<ordt_drv_reg> areg_1 = std::make_shared<ordt_drv_reg>("areg");
  areg_1->add_field("hier_fs_fs1_fld1", 0, 4, true, true);
  areg_1->add_field("hier_fs_fs1_fld2", 4, 1, true, true);
  areg_1->add_field("hier_fs_fld1", 5, 1, true, true);
  areg_1->add_field("hier_fs_fs2_fld1", 6, 4, true, true);
  areg_1->add_field("hier_fs_fs2_fld2", 14, 1, true, true);
  areg_1->add_field("fs3_fld1", 24, 4, true, true);
  areg_1->add_field("fs3_fld2", 28, 1, true, true);
  std::shared_ptr<ordt_drv_regset> foo_0 = std::make_shared<ordt_drv_regset>("foo");
  foo_0->add_child(1, blabla_2, 1, 8, 4);
  foo_0->add_child(1, areg_1, 2, 0, 4);
