...
class ordt_drv_root(ordt_drv_regset):
    ...
    def build(self):
        blabla_5 = ordt_drv_reg('blabla', 32)
        blabla_5.add_field('fs1_0_fld1', 0, 4, True, True, 0)
        blabla_5.add_field('fs1_0_fld2', 4, 1, True, True, None)
        blabla_5.add_field('fs1_1_fld1', 5, 4, True, True, 0)
        blabla_5.add_field('fs1_1_fld2', 9, 1, True, True, None)
        blabla_5.add_field('fs1_2_fld1', 10, 4, True, True, 0)
        blabla_5.add_field('fs1_2_fld2', 14, 1, True, True, None)
        blabla_5.add_field('fs3_0_fld1', 15, 4, True, True, 0)
        blabla_5.add_field('fs3_0_fld2', 19, 1, True, True, None)
        blabla_5.add_field('fs3_1_fld1', 23, 4, True, True, 0)
        blabla_5.add_field('fs3_1_fld2', 27, 1, True, True, None)
        areg_4 = ordt_drv_reg('areg', 32)
        areg_4.add_field('hier_fs_fs1_fld1', 0, 4, True, True, 0)
        areg_4.add_field('hier_fs_fs1_fld2', 4, 1, True, True, None)
        areg_4.add_field('hier_fs_fld1', 5, 1, True, True, None)
        areg_4.add_field('hier_fs_fs2_fld1', 6, 4, True, True, 0)
        areg_4.add_field('hier_fs_fs2_fld2', 14, 1, True, True, None)
        areg_4.add_field('fs3_fld1', 24, 4, True, True, 0)
        areg_4.add_field('fs3_fld2', 28, 1, True, True, None)
        foo_3 = ordt_drv_regset('foo')
        foo_3.add_child(1, blabla_5, 1, 8, 4)
        foo_3.add_child(1, areg_4, 2, 0, 4)
        self.add_child(1, foo_3, 1, 0, 0)
