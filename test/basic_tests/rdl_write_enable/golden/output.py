...
class ordt_drv_root(ordt_drv_regset):
    ...
    def build(self):
        intr_reg_7 = ordt_drv_reg('intr_reg', 32)
        intr_reg_7.add_field('count_fld', 0, 8, True, True, 85)
        intr_reg_7.add_field('intr1', 8, 1, True, True, 0)
        intr_reg_7.add_field('intr2', 9, 1, True, True, 0)
        array_reg_11 = ordt_drv_reg('array_reg', 32)
        array_reg_11.add_field('field32', 0, 32, True, True, 0)
        childmap_32b_10 = ordt_drv_regset('childmap_32b')
        childmap_32b_10.add_child(1, array_reg_11, 8, 0, 4)
        bigreg_9 = ordt_drv_reg('bigreg', 64)
        bigreg_9.add_field('field64', 0, 64, True, True, 0)
        log_reg_8 = ordt_drv_reg('log_reg', 32)
        log_reg_8.add_field('log_err', 0, 8, True, True, 4)
        log_reg_8.add_field('log_value', 8, 8, True, False, 0)
        foo_6 = ordt_drv_regset('foo')
        foo_6.add_child(1, intr_reg_7, 1, 0, 4)
        foo_6.add_child(1, childmap_32b_10, 1, 256, 32)
        foo_6.add_child(1, bigreg_9, 1, 8, 8)
        foo_6.add_child(1, log_reg_8, 1, 4, 4)
        self.add_child(1, foo_6, 1, 0, 0)
