...
class ordt_rg_intr_reg : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> count_fld;
    ordt_field<uint_fast8_t> intr1;
    ordt_field<uint_fast8_t> intr2;
    ordt_rg_intr_reg(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_log_reg : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> log_err;
    ordt_field<uint_fast8_t> log_value;
    ordt_rg_log_reg(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_bigreg : public ordt_reg {
  public:
    ordt_field<uint64_t> field64;
    ordt_rg_bigreg(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_childmap_32b_array_reg : public ordt_reg {
  public:
    ordt_field<uint32_t> field32;
    ordt_rg_childmap_32b_array_reg(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rset_childmap_32b : public ordt_regset {
  public:
    ordt_addr_elem_array<ordt_rg_childmap_32b_array_reg> array_reg;
    ordt_rset_childmap_32b(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual void update_child_ptrs();
};

class ordt_root : public ordt_regset {
  public:
    ordt_rg_intr_reg intr_reg;
    ordt_rg_log_reg log_reg;
    ordt_rg_bigreg bigreg;
    ordt_rset_childmap_32b childmap_32b;
    ordt_root();
