...
void  ordt_drv_root::build() {
  std::shared_ptr<ordt_drv_reg> intr_reg_1 = std::make_shared<ordt_drv_reg>("intr_reg");
  intr_reg_1->add_field("count_fld", 0, 8, true, true);
  intr_reg_1->add_field("intr1", 8, 1, true, true);
  intr_reg_1->add_field("intr2", 9, 1, true, true);
  std::shared_ptr<ordt_drv_reg> array_reg_5 = std::make_shared<ordt_drv_reg>("array_reg");
  array_reg_5->add_field("field32", 0, 32, true, true);
  std::shared_ptr<ordt_drv_regset> childmap_32b_4 = std::make_shared<ordt_drv_regset>("childmap_32b");
  childmap_32b_4->add_child(1, array_reg_5, 8, 0, 4);
  std::shared_ptr<ordt_drv_reg> bigreg_3 = std::make_shared<ordt_drv_reg>("bigreg");
  bigreg_3->add_field("field64", 0, 64, true, true);
  std::shared_ptr<ordt_drv_reg> log_reg_2 = std::make_shared<ordt_drv_reg>("log_reg");
  log_reg_2->add_field("log_err", 0, 8, true, true);
  log_reg_2->add_field("log_value", 8, 8, true, false);
  std::shared_ptr<ordt_drv_regset> foo_0 = std::make_shared<ordt_drv_regset>("foo");
  foo_0->add_child(1, intr_reg_1, 1, 0, 4);
  foo_0->add_child(1, childmap_32b_4, 1, 256, 32);
  foo_0->add_child(1, bigreg_3, 1, 8, 8);
  foo_0->add_child(1, log_reg_2, 1, 4, 4);
