//   Ordt 160713.01 autogenerated file 
//   Input: ./rdl_hier_01/test.rdl
//   Parms: ./rdl_hier_01/test.parms
//   Date: Wed Jul 13 12:57:14 EDT 2016
//

import uvm_pkg::*;
import uvm_reg_ordt_pkg::*;
...
class block_base_map_l2_r16_child_l3_child extends uvm_reg_block_rdl;
  ...
  virtual function void build();
    ...
    set_hdl_path_root({`BASE_MAPL2_R16_CHILD_PIO_INSTANCE_PATH, ".jrdl_logic"});
  endfunction: build
...
class block_base_map_l2_r16_child extends uvm_reg_block_rdl;
  ...
  virtual function void build();
    ...
    this.l3_child.set_rdl_tag("l3_child_");
      ...
      this.l3_child.set_rdl_address_map_hdl_path({`BASE_MAPL2_R16_CHILD_PIO_INSTANCE_PATH, ".jrdl_logic"});
    this.l3_child.build();
...
class block_base_map_l2_s8_child_l3_child extends uvm_reg_block_rdl;
  ...
  virtual function void build();
    ...
    this.ext_base_regs.build();
    this.default_map.add_submap(this.ext_base_regs.default_map, `UVM_REG_ADDR_WIDTH'h800);
    set_hdl_path_root({`BASE_MAPL2_S8_CHILD_PIO_INSTANCE_PATH, ".jrdl_logic"});
  endfunction: build
...
class block_base_map_l2_s8_child extends uvm_reg_block_rdl;
  ...
  virtual function void build();
    ...
    this.l3_child.set_rdl_tag("l3_child_");
      this.l3_child.set_rdl_address_map(1);
      this.l3_child.set_rdl_address_map_hdl_path({`BASE_MAPL2_S8_CHILD_PIO_INSTANCE_PATH, ".jrdl_logic"});
    this.l3_child.build();
    this.default_map.add_submap(this.l3_child.default_map, `UVM_REG_ADDR_WIDTH'h2000);
    set_hdl_path_root({`BASE_MAPL2_S8_CHILD_PIO_INSTANCE_PATH, ".jrdl_logic"});
  endfunction: build
...
class block_base_map extends uvm_reg_block_rdl;
  ...
  virtual function void build();
    ...
    this.set_rdl_address_map_hdl_path({`BASE_MAP_PIO_INSTANCE_PATH, ".jrdl_logic"});
    ...
    this.l2_r16_child.set_rdl_tag("l2_r16_child_");
      ...
      this.l2_r16_child.set_rdl_address_map_hdl_path({`BASE_MAPL2_R16_CHILD_PIO_INSTANCE_PATH, ".jrdl_logic"});
    ...
    this.l2_s8_child.set_rdl_tag("l2_s8_child_");
      ...
      this.l2_s8_child.set_rdl_address_map_hdl_path({`BASE_MAPL2_S8_CHILD_PIO_INSTANCE_PATH, ".jrdl_logic"});
    this.l2_s8_child.build();
    this.default_map.add_submap(this.l2_s8_child.default_map, `UVM_REG_ADDR_WIDTH'h30000);
    set_hdl_path_root({`BASE_MAP_PIO_INSTANCE_PATH, ".jrdl_logic"});
    this.add_callbacks();
  endfunction: build
