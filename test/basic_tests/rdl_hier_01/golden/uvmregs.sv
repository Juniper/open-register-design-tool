//   Ordt 170705.01 autogenerated file 
//   Input: ./rdl_hier_01/test.rdl
//   Parms: ./rdl_hier_01/test.parms
//   Date: Wed Jul 05 14:46:00 EDT 2017
//
...
// State reg
class reg_base_map_opt_reg extends uvm_reg_rdl;
  string m_rdl_tag;
  rand uvm_reg_field_rdl lsb_field;
  
  function new(string name = "reg_base_map_opt_reg");
    super.new(name, 32, UVM_NO_COVERAGE);
  endfunction: new
...
class block_base_map extends uvm_reg_block_rdl;
  ...
  rand reg_base_map_opt_reg opt_reg;
